...
class STARmapAutomationControllerGUI(QMainWindow):
	...
	def __init__(self, *args, **kwargs):
		...
		self.manualFlowWidget = widgets.ManualFlowWidget(self.fluidController)
		...
		layout.addWidget(self.manualFlowWidget,4,0)
		...
		self.manualFlowWidget.log_message.connect(self.logWidget.addItem)
		...
		self.manualFlowWidget.log_message.connect(self.logWidget.scrollToBottom)
		...
		self.manualFlowWidget.log_message.connect(self.logger.log)
